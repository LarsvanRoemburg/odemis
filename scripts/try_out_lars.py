...
for nnn in np.arange(4, 18, 1, dtype=int):  # range(len(data_paths_after)) OR np.arange(4, 9, 1, dtype=int)
    ...
    key_points, yxr = detect_blobs(binary_end_result2, min_circ=0.6, min_area=7**2/2, plotting=True)
